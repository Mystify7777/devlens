...
normal, working root script. In fact no package in the workspace —
across six packages spanning three years of this project's own
history — has ever defined a `lint` script. Every invocation of
`pnpm lint` fails immediately with `ERR_PNPM_RECURSIVE_RUN_NO_SCRIPT`.
...
| Behavioral regressions                                                                               | 627 tests across the workspace, run before every commit                                                                                                                                                                                                                                                                                                                |
